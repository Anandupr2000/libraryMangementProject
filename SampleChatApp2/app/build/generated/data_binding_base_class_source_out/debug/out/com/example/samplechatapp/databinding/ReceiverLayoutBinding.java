...
public final class ReceiverLayoutBinding implements ViewBinding {
  ...
  private ReceiverLayoutBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView feeling,
      @NonNull TextView receivermsg) {
  ...
  public static ReceiverLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.receivermsg;
      TextView receivermsg = rootView.findViewById(id);
      if (receivermsg == null) {
        break missingId;
      }

      return new ReceiverLayoutBinding((ConstraintLayout) rootView, feeling, receivermsg);
    }
