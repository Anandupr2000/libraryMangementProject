...
public final class SenderLayoutBinding implements ViewBinding {
  ...
  private SenderLayoutBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView feeling,
      @NonNull TextView sendermsg) {
  ...
  public static SenderLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.sendermsg;
      TextView sendermsg = rootView.findViewById(id);
      if (sendermsg == null) {
        break missingId;
      }

      return new SenderLayoutBinding((ConstraintLayout) rootView, feeling, sendermsg);
    }
